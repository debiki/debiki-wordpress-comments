<?php
/**
 * Copyright 2003-2010 by the contributors [to WordPress and (?) b2]
 * Copyright 2011 by the contributors [to WordPress and (?) b2]
 * b2 is released under the GPL.
 * WordPress is released under the GPL.
 * See `license.txt` in the WordPress installation dir.
 *
 * Parts Copyright (c) 2012 Kaj Magnus Lindberg
 * License: GPL v2 or later.
 *
 * I (KajMagnus) have:
 * 1. Copy-pasted these files:
 *    wp-includes/comment-template.php, class Walker_Comment only
 *    wp-includes/class-wp-walker.php
 * 2. Prefixed the classes with Debiki_tmp_ and Debiki_.
 */
 ...
 * @since 2.7.0
 */
class Debiki_tmp_Walker_Comment extends Debiki_Walker {
	/**
